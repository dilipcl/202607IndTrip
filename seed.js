...
window.SEED = {
  ...
  passengers: [
    { id: "p_t1",   name: "Lead traveller", age: 0, gender: "M", group: "UK", role: "Lead", notes: "" },
    { id: "p_t2", name: "Traveller 2",    age: 0, gender: "F", group: "UK", role: "Spouse" },
    { id: "p_t3",   name: "Traveller 3",    age: 0, gender: "M", group: "UK", role: "Child" },
    { id: "p_t4",  name: "Traveller 4",    age: 0, gender: "F", group: "UK", role: "Child" },
    { id: "p_r1",     name: "Relative 1", age: 0, gender: "M", group: "IN", role: "Relative" },
    { id: "p_r2",     name: "Relative 2", age: 0, gender: "F", group: "IN", role: "Elder" },
    { id: "p_r3",    name: "Relative 3", age: 0, gender: "F", group: "IN", role: "Elder" },
    { id: "p_r4",   name: "Relative 4", age: 0, gender: "F", group: "IN", role: "Elder" },
    { id: "p_r5",   name: "Relative 5", age: 0, gender: "M", group: "IN", role: "Co-organiser" },
    { id: "p_r6",     name: "Relative 6", age: 0, gender: "F", group: "IN", role: "Relative" },
    { id: "p_r7",  name: "Relative 7", age: 0, gender: "F", group: "IN", role: "Elder" },
    { id: "p_r8",     name: "Relative 8", age: 0, gender: "F", group: "IN", role: "Relative" },
    { id: "p_r9", name: "Relative 9", age: 0, gender: "M", group: "IN", role: "Relative" },
  ],
  ...
  flightTickets: [
    { passenger: "p_t1",   ticket: "", outSeats: "16K / 25K", totalGBP: 947.47 },
    { passenger: "p_t2", ticket: "", outSeats: "16G / 25G", totalGBP: 947.47 },
    { passenger: "p_t3",   ticket: "", outSeats: "16H / 25H", totalGBP: 845.47 },
    { passenger: "p_t4",  ticket: "", outSeats: "16J / 25J", totalGBP: 719.47 },
  ],
  flightRules: {
    ...
    { id: "t_north", direction: "Northbound", train: "20632 / TVC MAQ Vande Bharat Exp",
      ...
      pnrs: [
        { pnr: "", board: "TVC 16:05", farINR: 6425.40,
          seats: [ { p: "p_t1", s: "C10/20" }, { p: "p_r2", s: "C10/21" }, { p: "p_r3", s: "C10/22" }, { p: "p_t3", s: "C10/23" } ] },
        { pnr: "", board: "TVC 16:05", farINR: 4824.95,
          seats: [ { p: "p_t2", s: "C10/25" }, { p: "p_r1", s: "C10/26" }, { p: "p_t4", s: "C10/27" } ] },
        { pnr: "", board: "ERS 18:45", farINR: 7256.30,
          seats: [ { p: "p_r5", s: "C10/10" }, { p: "p_r6", s: "C10/11" }, { p: "p_r7", s: "C10/12" }, { p: "p_r8", s: "C10/13" }, { p: "p_r9", s: "C10/14" }, { p: "p_r4", s: "C10/15" } ] },
      ] },
    { id: "t_south", direction: "Southbound", train: "20633 / TVC Vande Bharat",
      ...
      pnrs: [
        { pnr: "", board: "KGQ 14:30", farINR: 9266.30,
          seats: [ { p: "p_t1", s: "C7/1 (window)" }, { p: "p_r2", s: "C7/2" }, { p: "p_r4", s: "C7/3" }, { p: "p_r3", s: "C7/4 (window)" }, { p: "p_t4", s: "C7/5 (window)" }, { p: "p_t3", s: "C7/6" } ] },
        { pnr: "", board: "KGQ 14:30", farINR: 4644.95,
          seats: [ { p: "p_r5", s: "C7/7" }, { p: "p_r7", s: "C7/8" }, { p: "p_r9", s: "C7/9 (window)" } ] },
        { pnr: "", board: "KGQ 14:30", farINR: 6185.40,
          seats: [ { p: "p_r1", s: "C7/16" }, { p: "p_t2", s: "C7/17" }, { p: "p_r6", s: "C7/18" }, { p: "p_r8", s: "C7/19 (window)" } ] },
      ] },
  ],
  ...
  anchors: [
    ...
    { id: "a_psk",     date: "2026-07-30", time: "14:30", title: "PSK Trivandrum — kids' passport appointment", kind: "admin",
      detail: "REPORTING TIME 14:30 for both children (one slot each, back-to-back). PSK Vazhuthacaud: Ground Floor, Carmel Towers, opp. Cotton Hill Girls High School. Both parents must attend with originals + signed Annexure-D. Allow 2–3h inside. Booked 23 Jul 2026; applications are ORDINARY (not Tatkaal) — see the Passport task list.",
      transport: "Taxi (out-and-back, city)" },
    { id: "a_bank",    date: "2026-07-30", time: "",      title: "NRI bank / MF updates", kind: "admin",
      detail: "Financial admin task (not spend). CLASH: the PSK passport appointment the same day reports at 14:30 and runs into the late afternoon — do the bank/MF visits in the MORNING of 30 Jul, or move them to 31 Jul alongside the CA meeting." },
  ...
  checklist: [
    ...
    { id: "v_airspace", cat: "Verify", priority: "high", status: "open",
      ...
      note: "STATUS 24 Jul 2026 (3 days pre-departure), re-checked at source:\n\n• FCDO UAE — last updated 13 Jul 2026, UNCHANGED since. There is NO 'advise against all but essential travel' for the UAE. Wording remains 'the situation remains unpredictable and attacks could resume at short notice.' Because FCDO does not advise against travel, the policy's FCDO exclusion is not triggered.\n\n• EASA CZIB-2026-07 — now at revision R1, revised 22 Jul, and the validity has been EXTENDED from 29 Jul to 31 AUGUST 2026. It tells operators not to fly the Bahrain, Kuwait, Qatar and UAE FIRs at all altitudes. This is the material change: the advisory now spans the WHOLE trip, so it covers the 17 Aug return (EK523/EK029) as well as the outbound — the earlier assumption that it would lapse before the return is dead.\n\n• IMPORTANT SCOPE LIMIT: a CZIB binds EU/EASA-regulated operators and foreign carriers holding EASA authorisation. Emirates is a UAE carrier and is NOT grounded by it — DXB is operating normally and Emirates is flying ~90% of its schedule, while classifying operations as 'reduced until further notice'. European carriers are the ones rerouting (+45–90 min on some sectors). So the realistic exposure is DELAY and knock-on scheduling at DXB, not cancellation of your specific flights.\n\nBefore 27 Jul AND before 17 Aug: check the FCDO UAE page + Emirates flight status for EK012/EK522 out and EK523/EK029 back. Rebooking: outbound is Flex (change USD 150), return is Saver (date change ≈ USD 25/pax). All four legs are registered with SmartDelay, which pays out at 120 min+ delay." },
    { id: "v_passport", cat: "Verify", priority: "high", status: "open",
      title: "Kids' passports: confirm the OLD books stay valid for the 17 Aug flight",
      note: "⚠ THE ONE THING TO RESOLVE AT THE PSK ON 30 JUL. Both applications were submitted 23 Jul 2026 under the ORDINARY scheme, NOT Tatkaal — appointment 30 Jul, 14:30. Ordinary dispatch is typically ~2–3 weeks (police verification dependent), against a 17 Aug departure only 18 days later, so the new books may well NOT arrive in time.\n\nThe risk is not the delay itself — it is the OLD passports. On a re-issue the PSK normally cancels (punches) the current passport, and a cancelled passport cannot be used to board. The children's existing books are valid to 27 Jul 2027 and hold the UK visa; if those are voided on 30 Jul and the new ones arrive after 17 Aug, they have no valid travel document for the return.\n\nASK AT THE COUNTER on 30 Jul: can the old passports be returned UNCANCELLED until the new ones are delivered, given confirmed international travel on 17 Aug? Carry the Emirates return e-tickets as proof. If the answer is no, ask about upgrading to Tatkaal (dispatch 1–3 working days) there and then. Resolve this before leaving the building." },
    ...
    { id: "pp1", cat: "Passport", priority: "high", status: "done", title: "1. Apply online — passportindia.gov.in",
      note: "✅ DONE 23 Jul 2026 — one Re-issue application submitted per child, payment successful on both. ⚠ Both were filed under the ORDINARY scheme, NOT Tatkaal as originally planned. That changes the dispatch timeline (see step 4) and is the reason the old-passport question in the Verify list matters. ARNs are in the private import." },
    { id: "pp2", cat: "Passport", priority: "high", status: "done", title: "2. Book PSK Trivandrum appointment",
      note: "✅ DONE — booked 23 Jul 2026 for BOTH children on Thu 30 Jul 2026, reporting time 14:30, at PSK Vazhuthacaud (Ground Floor, Carmel Towers, opp. Cotton Hill Girls High School, Trivandrum). Status Active on the portal. Still to print: the application receipt for each child and the Annexure-D consent (see 'Emails to send' → Annexure-D), signed by both parents." },
    { id: "pp3", cat: "Passport", priority: "high", status: "open", title: "3. Attend PSK — Thu 30 Jul, report 14:30",
      note: "PSK Vazhuthacaud, Carmel Towers (opp. Cotton Hill Girls High School). Report 14:30; allow 2–3h inside, so keep the afternoon clear — the NRI bank/MF anchor is the same day and must move to the morning.\n\nBring: both children's ORIGINAL passports; both parents' passports + self-attested copies; address proof (parent's Aadhaar/passport showing the India address); signed Annexure-D (one per child); the printed application receipt for each ARN. Photos/biometrics taken on-site. Both parents present → usually no police verification for minors. Birth certificates NOT needed (children born before Oct 2023).\n\nDON'T LEAVE WITHOUT settling the old-passport/cancellation question — see the Verify item." },
    { id: "pp4", cat: "Passport", priority: "high", status: "open", title: "4. Receive new passports (Speed Post)",
      note: "⚠ TIMELINE CHANGED — these are ORDINARY applications, not Tatkaal. Expect roughly 2–3 weeks from the 30 Jul appointment (police-verification dependent), NOT the 1–3 working days Tatkaal would have given. Against a 17 Aug departure that is genuinely tight, so treat late arrival as the LIKELY case, not the fallback.\n\nDispatched to the India address — NOT collected. Track on Passport Seva. ARRANGE NOW: a named relative at that address who will receive both books and courier them to the UK if they land after 17 Aug." },
    { id: "pp5", cat: "Passport", priority: "high", status: "open", title: "5. Update UKVI eVisa + carry old passports home",
      note: "Applies the moment each new passport is in hand — before flying 17 Aug if they arrive in time, otherwise from the UK as soon as they're couriered over. Log into each child's UKVI account and update the passport number: the eVisa does NOT auto-transfer and airline/border checks match against it. Carry BOTH passports (the old book holds the UK visa vignette). If the new books have not arrived by 17 Aug, the children fly home on the existing passports — which only works if those were NOT cancelled on 30 Jul (see the Verify item)." },
  ],
  ...
  docPackets: [
    ...
    },
    {
      ...
      when: "Appointment Thu 30 Jul, report 14:30",
      intro: "Applied 23 Jul 2026; appointment booked for BOTH children on Thu 30 Jul, reporting 14:30, at PSK Vazhuthacaud (Ground Floor, Carmel Towers, opp. Cotton Hill Girls High School, Trivandrum). The step-by-step process is in the Passport task list above. This card is the DOCUMENT pack to carry on the day.\n\n⚠ Filed as ORDINARY, not Tatkaal — so no Tatkaal undertaking is required, but dispatch is ~2–3 weeks and the old-passport cancellation question must be settled at the counter (see the Verify list).\n\n➡ Marriage certificate: NOT normally required for a minor re-issue when both parents' names already appear in the child's current passport and both parents attend — Annexure-D covers consent. Carry a copy only as backup.",
      docs: [
        { id: "dk_old", label: "Both children's ORIGINAL current passports", status: "need", note: "⚠ Normally cancelled at re-issue. Ask whether they can be returned UNCANCELLED until the new books arrive — the old one holds the UK visa and may be the only valid document for the 17 Aug flight." },
        ...
        { id: "dk_receipt", label: "Application receipt — one printout per child (ARN)", status: "need", note: "Available now: Passport Seva → My Applications → the application → 'Print Application Receipt'. Print both before 30 Jul; ARNs and appointment IDs are in the private import." },
        { id: "dk_rettkt", label: "Emirates return e-tickets (17 Aug)", status: "need", note: "Evidence of confirmed international travel — supports the request to keep the old passports usable until the new ones arrive." },
  ...
  alerts: [
    { id: "al_sd1", title: "SmartDelay: register EK012 (LGW→DXB)", due: "2026-07-26", kind: "smartdelay", done: true,
      note: "✅ Confirmed by SmartDelay email 22 Jul 2026, 20:35 — EK 12, 27 Jul, dep 09:05 (the RETIMED time, so the registration is current). All 4 UK travellers listed." },
    { id: "al_sd2", title: "SmartDelay: register EK522 (DXB→TRV)", due: "2026-07-26", kind: "smartdelay", done: true,
      note: "✅ Confirmed by SmartDelay email 22 Jul 2026, 20:35 — EK 522, 27 Jul, dep 21:25 DXB→TRV. All 4 UK travellers listed." },
    { id: "al_sd3", title: "SmartDelay: register EK523 (TRV→DXB)", due: "2026-07-26", kind: "smartdelay", done: true,
      note: "✅ ALREADY DONE — confirmed by SmartDelay email 22 Jul 2026, 20:35 for EK 523, 17 Aug, dep 04:45. The earlier assumption that the portal only accepts registration close to departure was WRONG: all four legs registered 26 days ahead in one go. Do NOT re-register." },
    { id: "al_sd4", title: "SmartDelay: register EK029 (DXB→LHR)", due: "2026-07-26", kind: "smartdelay", done: true,
      note: "✅ ALREADY DONE — confirmed by SmartDelay email 22 Jul 2026, 20:35 for EK 29, 17 Aug, dep 09:40 DXB→LHR. Do NOT re-register." },
    { id: "al_sd_retime", title: "If Emirates retimes any leg: re-do SmartDelay for it", due: "2026-08-15", kind: "smartdelay",
      note: "All four legs are registered against their CURRENT times (EK012 09:05, EK522 21:25, EK523 04:45, EK029 09:40). SmartDelay has no way to amend a registration — if Emirates moves a flight, you must CANCEL and RE-REGISTER that leg at least 24h before the new departure, using the cancel link in the confirmation email. Check this alongside the pre-return Gulf/Emirates check on 15 Aug." },
    ...
    { id: "al_pp_old", title: "⚠ Ask PSK: do the OLD passports stay valid for 17 Aug?", due: "2026-07-30", kind: "warning",
      note: "Applications went in as ORDINARY, not Tatkaal — dispatch ~2–3 weeks against an 18-day runway to the 17 Aug flight. On a re-issue the PSK normally cancels the current passport, and a cancelled book cannot be used to board. Ask at the counter whether the old passports can be returned uncancelled given confirmed 17 Aug international travel (carry the Emirates return e-tickets), or whether the applications can be upgraded to Tatkaal. Do not leave without an answer." },
    { id: "al_pp_track", title: "Track passport dispatch — decide courier vs carry", due: "2026-08-12", kind: "admin",
      note: "~2 weeks after the appointment: check Passport Seva status for both ARNs. If the books have not been dispatched by now they will almost certainly miss the 17 Aug flight — confirm the named relative at the India address is ready to receive and courier them to the UK, and make sure the children's travel documents for 17 Aug are settled." },
    ...
    { id: "al_airspace", title: "Gulf airspace / Dubai transit check before return", due: "2026-08-15", kind: "verify",
      note: "⚠ RAISED IN IMPORTANCE 24 Jul: EASA CZIB-2026-07R1 was extended on 22 Jul to 31 AUG 2026, so unlike the earlier assumption the avoid-UAE-airspace advisory is still live ON your 17 Aug return date. It does not bind Emirates (a UAE carrier) and DXB is operating, but it means sustained delay risk through the whole trip rather than a situation that resolves before you fly home. Re-check the FCDO UAE page + Emirates status for EK523/EK029, and know the rebooking option (return is Saver, date change ≈ USD 25/pax). SmartDelay is registered on both return legs and pays from 120 min." },
