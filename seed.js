...
window.SEED = {
  ...
  alerts: [
    ...
    { id: "al_sd3", title: "SmartDelay: register EK523 (TRV→DXB)", due: "2026-08-16", kind: "smartdelay", done: true,
      note: "✅ Registered in the CSP portal." },
    { id: "al_sd4", title: "SmartDelay: register EK029 (DXB→LHR)", due: "2026-08-16", kind: "smartdelay", done: true,
      note: "✅ Registered in the CSP portal." },
